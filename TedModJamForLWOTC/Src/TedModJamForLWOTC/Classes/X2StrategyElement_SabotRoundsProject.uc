class X2StrategyElement_SabotRoundsProject extends X2StrategyElement_DefaultTechs;
...
static function array<X2DataTemplate> CreateTemplates()
{
    ...
    {
      Techs.AddItem(CreateSabotRoundsProjectTemplate());
    }
...
static function X2DataTemplate CreateSabotRoundsProjectTemplate()
{
	local X2TechTemplate Template;
	local ArtifactCost Resources;

	`CREATE_X2TEMPLATE(class'X2TechTemplate', Template, 'SabotRoundsProject');
	...
	Template.Requirements.RequiredTechs.AddItem('AutopsyAdventSniper');
	
	Template.Requirements.RequiredItems.AddItem('CorpseAdventSniper');
	Resources.ItemTemplateName='CorpseAdventSniper';
	...
	Template.ItemRewards.AddItem('IRI_Ammo_Sabot');
