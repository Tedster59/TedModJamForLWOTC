...
var config int XCOM_BIOSHIELD_AIM;
var config WeaponDamageValue XCOM_BIOSHIELD_BASEDAMAGE;
var config WeaponDamageValue XCOM_BIOSHIELD_BM_BASEDAMAGE;
...
static function X2DataTemplate XComBioShield()
{
	...
	Template.Aim = default.XCOM_BIOSHIELD_AIM;
...
static function X2DataTemplate XComBioShield_BM()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'XComBioShield_BM');
	Template.WeaponPanelImage = "_Sword";                       // used by the UI. Probably determines iconview of the weapon.
	...
	Template.BaseDamage = default.XCOM_BIOSHIELD_BM_BASEDAMAGE;
	Template.BaseDamage.DamageType='Melee';
	Template.iSoundRange = 2;
	Template.iEnvironmentDamage = 0;
	Template.iIdealRange = 0;
