class X2Ability_XComAssaultStun extends X2Ability;

static function array<X2DataTemplate> CreateTemplates()
{
	local array<X2DataTemplate> Templates;
	
	Templates.AddItem(CreateXComAssaultStun());
	Templates.AddItem(CreateXComAssaultStunImpairEffectAbility());
	
	return Templates;
}

static function X2AbilityTemplate CreateXComAssaultStun()
{
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'XComAssaultStun');

	Template.AbilitySourceName = 'eAbilitySource_Standard';
	Template.eAbilityIconBehaviorHUD = EAbilityIconBehavior_AlwaysShow;
	Template.IconImage = "img:///UILibrary_PerkIcons.UIPerk_adventstunlancer_stunlance";

	Template.AdditionalAbilities.AddItem('XComAssaultStunImpair');
	...
	ImpairingAbilityEffect.AbilityName = 'XComAssaultStunImpair';
...
static function X2DataTemplate CreateXComAssaultStunImpairEffectAbility()
{
	local X2AbilityTemplate                 Template;
	...
	`CREATE_X2ABILITY_TEMPLATE(Template, 'XComAssaultStunImpair');
	...
	UnconsciousEffect = class'X2StatusEffects'.static.CreateStunnedStatusEffect(4, 100, false);
	...
	if( AbilityContext.EventChainStartIndex != 0 )
	{
		...
		for( i = AbilityContext.EventChainStartIndex; !Context.bLastEventInChain; ++i )
		{
			...
			if( bAbilityWasSuccess &&
				TestAbilityContext.InputContext.AbilityTemplateName == 'XComAssaultStunImpair' &&
