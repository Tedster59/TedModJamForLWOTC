class X2Item_MagneticKSM extends X2Item config(KineticStrikeModule);
...
static function X2DataTemplate CreateItem_MagneticStrikeModule()
{
	local X2WeaponTemplate Template;
	
	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'MagneticStrikeModule');
