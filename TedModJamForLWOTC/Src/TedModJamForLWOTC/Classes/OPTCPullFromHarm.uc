class OPTCPullFromHarm extends X2DownloadableContentInfo config(Game);

var config name PullFromHarmAbility;
...
static event OnPostTemplatesCreated()
{
    ...
    Template = AbilityTemplateManager.FindAbilityTemplate(default.PullFromHarmAbility);
