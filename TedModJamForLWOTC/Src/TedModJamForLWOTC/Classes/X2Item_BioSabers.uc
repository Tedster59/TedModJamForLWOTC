...
var config int XCOM_BIO_SABER_AIM;
var config int XCOM_BIO_SABER_CRITCHANCE;
var config WeaponDamageValue XCOM_BIO_SABER_BM_BASEDAMAGE;
...
static function X2DataTemplate CreateTemplate_XComBioSaber()
{
	...
	Template.CritChance = default.XCOM_BIO_SABER_CRITCHANCE;
	Template.Aim = default.XCOM_BIO_SABER_AIM;
	Template.BaseDamage.DamageType='Melee';
	Template.iSoundRange = 2;
...
static function X2DataTemplate CreateTemplate_XComBioSaber_BM()
{
	local X2WeaponTemplate Template;

	`CREATE_X2TEMPLATE(class'X2WeaponTemplate', Template, 'XComBioSaber_BM');
	...
	Template.iPhysicsImpulse = 5;
	Template.iIdealRange = 1;
	Template.BaseDamage = default.XCOM_BIO_SABER_BM_BASEDAMAGE;
	Template.CritChance = default.XCOM_BIO_SABER_CRITCHANCE;
	Template.Aim = default.XCOM_BIO_SABER_AIM;
	Template.BaseDamage.DamageType='Melee';
	Template.iSoundRange = 2;
