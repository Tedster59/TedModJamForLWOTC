class OPTC_Bind extends X2DownloadableContentInfo config(Game);

var config name BindAbility;
...
static event OnPostTemplatesCreated()
{
    ...
    Template = AbilityTemplateManager.FindAbilityTemplate(default.BindAbility);
