class OPTC_GetOverHere extends X2DownloadableContentInfo config(Game);

//var config name GetOverHereAbility;
...
static event OnPostTemplatesCreated()
{
    ...
    Template = AbilityTemplateManager.FindAbilityTemplate('GetOverHere');
    ...
    if (Template != none)
    {
		...
		`LOG("Added TooHeavyForPullCondition");
    }
}